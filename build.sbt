...
//    val tapirHttp4s = "com.softwaremill.tapir" %% "tapir-http4s-server" % Version.tapir
    ...
    val tapirJsonCirce =
      "com.softwaremill.sttp.tapir" %% "tapir-json-circe" % Version.sttpTapirJsonCirce
    val tapirSwagger     = "com.softwaremill.sttp.tapir" %% "tapir-swagger-ui-akka-http" % Version.tapir
    val tapirRedoc       = "com.softwaremill.sttp.tapir" %% "tapir-redoc-akka-http"      % Version.tapir
